...
// RealmRoleReconciler reconciles RealmRole resources through the shared engine.
...
func (r *RealmRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	var obj keycloakv1alpha1.RealmRole
	if err := r.Get(ctx, req.NamespacedName, &obj); err != nil {
		return ctrl.Result{}, client.IgnoreNotFound(err)
	}
	return r.Engine.Reconcile(ctx, &obj, RealmRoleDriver{})
}
