...
// KeycloakConnectionReconciler reconciles a KeycloakConnection object
type KeycloakConnectionReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=keycloak.ctn-solutions.io,resources=keycloakconnections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=keycloak.ctn-solutions.io,resources=keycloakconnections/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=keycloak.ctn-solutions.io,resources=keycloakconnections/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the KeycloakConnection object against the actual cluster state, and then
